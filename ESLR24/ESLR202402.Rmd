...
server <- function(input, output) {
  ...
  hist(randomData, freq = TRUE,  breaks = 50,  xlim = c(-10,10), ylim = c(0,1000),xlab = "Reward", ylab = "Frequency",  main = "Patch01 reward")
})
...
**Value function: Rescorla-Wagner rule** <br>
...
$$ <br> $\beta$ inverse temperature: stochasticity of action(exploration-exploitation tendency)
...
Value is then updated by $Q_{a,t+1 }\leftarrow (1-\alpha)Q_{a,t } + \alpha\pi_{a,t}$
